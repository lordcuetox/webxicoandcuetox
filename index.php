            ...
            <div class="container">
                <div class="box">
                    ...
                    <ul class="portfolio-filter">
                        ...
                        <li><a class="btn btn-primary" href="#" data-filter=".php">PHP</a></li>
                        <li><a class="btn btn-primary" href="#" data-filter=".bootstrap3">Bootstrap 3</a></li>
                        <li><a class="btn btn-primary" href="#" data-filter=".android">Android</a></li>
                        <li><a class="btn btn-primary" href="#" data-filter=".ios">iOS</a></li>
                    ...
                    <ul class="portfolio-items col-4">
                        <!--/.portfolio-item-->
                        <li class="portfolio-item apps php bootstrap3">
                            <div class="item-inner">
                                <div class="portfolio-image">
                                    <img src="images/portfolio/thumb/msfstore2.png" alt="">
                                    <div class="overlay">
                                        <a class="preview btn btn-danger" title="MSF Store | Todo para el Mason, Todo para su logia" href="images/portfolio/full/msfstore.png"><i class="icon-eye-open"></i></a>             
                                    </div>
                                </div>
                                <h5>MSFStore</h5>
                            </div>
                        ...
                        <li class="portfolio-item apps php bootstrap3">
                            <div class="item-inner">
                                <div class="portfolio-image">
                                    <img src="images/portfolio/thumb/msf2.png" alt="">
                                    <div class="overlay">
                                        <a class="preview btn btn-danger" title="MSF | Masoneria Sin Fronteras" href="images/portfolio/full/msf.png"><i class="icon-eye-open"></i></a>             
                                    </div>
                                </div>
                                <h5>MSF</h5>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        &copy; <?php echo date("Y"); ?> Webxico & Cuetox. Todos los derechos reservados.
                    </div>
                </div>
            </div>
        </footer><!--/#footer-->
